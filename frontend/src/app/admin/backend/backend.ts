...
export const checkWhitelist = async (email: string) => {
  const res = await fetch(`${API_URL}/api/check-whitelist`, {
    method: "POST",
    headers: {
...
export const deleteCompany = async (companyID: string) => {
  return fetch(`${API_URL}/api/company/${companyID}`, {
    method: "DELETE",
  });
};
...
export const updateCompany = async (
  companyID: string,
  data: { Name: string; Industry: string; CaseStudies: string[] }
) => {
  return fetch(`${API_URL}/api/company/${companyID}`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
...
export const updateCaseStudyTags = async (
  caseStudyID: string,
  tags: string[]
) => {
  return fetch(`${API_URL}/api/casestudy/${caseStudyID}/tags`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
