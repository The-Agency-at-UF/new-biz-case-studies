  ...
  return (
    <section className="relative overflow-hidden py-12 md:py-20">
      <div className="relative z-10 px-6 md:px-12 lg:pl-20 lg:pr-0">
        <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,1fr)_34rem] lg:gap-12 xl:grid-cols-[minmax(0,1fr)_40rem]">
          ...
          <div className="relative mx-auto w-full max-w-[18rem] lg:ml-auto lg:mr-0 lg:-mt-12 lg:w-[18rem] lg:max-w-[18rem]">
