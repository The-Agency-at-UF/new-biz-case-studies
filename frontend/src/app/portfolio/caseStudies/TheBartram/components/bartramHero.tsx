      ...
      <div className="relative">
        ...
        <div className="absolute flex flex-col h-full px-15 md:px-30 lg:px-40 inset-0 bg-gradient-to-t from-[#A4D1D9] from-20% via-[#A4D1D9]/3 via-80% to-transparent">
            <div className="h-full z-10 flex flex-col justify-center py-10">
                <p className="border-[2px] md:border-[3px] border-white px-2 md:px-6 py-1 md:max-2xl:py-2 rounded-none text-xs lg:text-lg font-bold tracking-wider uppercase bg-[#85AE6B]/30 backdrop-blur-sm w-fit">
                case study</p>
                ...
                <p className="text-xs text-white md:text-xl">Distinguishing a local, luxury apartment complex from competitors in a saturated market</p>
            </div>
