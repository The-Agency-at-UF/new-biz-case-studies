    ...
    <div className="relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#F55096] from-20% via-[#F55096]/3 via-80% to-transparent">
            <div className="h-full z-10 flex flex-col justify-center px-8 md:px-10 lg:px-12 max-w-[800px]">
                <p className={`${gentonaMedium.className} border-[2px] md:border-[3px] border-[#75CFE5] px-2 md:px-6 py-2 md:max-2xl:py-2 rounded-none text-xs lg:text-lg font-bold tracking-wider uppercase bg-[#F55096]/50 backdrop-blur-sm w-fit`}>
                case study</p>
