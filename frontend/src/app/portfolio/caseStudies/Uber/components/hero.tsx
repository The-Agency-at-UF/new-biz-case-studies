...
export default function UberHero() {
  return (
    <div className={`relative w-full h-[750px] mt-25 overflow-hidden ${gentonaMedium.className}`}> 
      <Image
      ...
      <div className="absolute inset-0 bg-black/10 bg-gradient-to-t from-[#1a2a2f] via-transparent to-transparent">
        <div className="max-w-7xl mx-auto h-full flex flex-col justify-end pb-12 pl-40 px-8">
          ...
          <div className="mb-6">
            <span className="border-[3px] border-white px-6 py-2 rounded-none text-xl font-bold tracking-wider uppercase bg-[#68BF70]/51 backdrop-blur-sm text-white">
              Case Study
            </span>
          </div>
          ...
          <p className="text-4xl md:text-5xl font-medium max-w-5xl leading-tight drop-shadow-2xl text-white">
