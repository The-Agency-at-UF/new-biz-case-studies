...
export default function OpportunitySection() {
  return (
          <div className="relativeflex flex-col h-full px-15 md:px-30 lg:px-40 inset-0">
        ...
        <h2 className={`${gentonaMedium.className} text-4xl lg:text-[8rem] font-black uppercase leading-[0.8] tracking-normal`}>
          ...
          <span className="block text-[#76c893]">Opportunity</span>
             ...
             We saw the chance to help the tech giant connect with more audiences.<br></br><br></br>
